...
| [04 상세 구현 계획](../IMPLEMENTATION_PLAN.md) | 작업 시작 전 | C 화면 상태, API 계약, Vertical Slice·테스트 순서 |
...
| [Figma MCP 구현 가이드](figma-mcp-implementation-guide-2026-07-14.md) | 디자인 구현 시작 전/후 | 프로토타입 반영 범위, 실제 구현 작업, 화면별 체크리스트 |
